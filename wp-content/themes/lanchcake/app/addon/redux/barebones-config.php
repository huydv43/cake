...
$args = array(
	...
	'menu_title'                => esc_html__( 'MyTheme Options', 'your-textdomain-here' ),
	'page_title'                => esc_html__( 'MyTheme Options', 'your-textdomain-here' ),
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( __( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $mytheme', 'your-textdomain-here' ) . '</p>', '<strong>' . $v . '</strong>' );
} else {
...
/**
 * thiết lập "GENERAL"
 * by biendv (biendv@ancu.com) at 2020-10-01
 */
...
Redux::setSection($opt_name, array(
    ...
    'fields'           => array(
        ...
        array(
            'id'       => 'opt_logo_transparent',
            'type'     => 'media',
            'url'      => true,
            'title'    => __('Your Transparent Logo'),
            'compiler' => 'true',
            'default'  => array('url' => ''),
        ),
        array(
...
// Class Parent Menu
Redux::setSection($opt_name, array(
    'title'            => __('Parent Menu (class)'),
    'id'               => 'general_parent_menu',
    'subsection'       => true,
    'customizer_width' => '450px',
    'fields'           => array(
        array(
            'id'       => 'opt_parent_menu_01',
            'type'     => 'text',
            'url'      => true,
            'title'    => __('Parent Menu 01'),
            'compiler' => 'true',
            'default'  => '',
        ),
        array(
            'id'       => 'opt_parent_menu_02',
            'type'     => 'text',
            'url'      => true,
            'title'    => __('Parent Menu 02'),
            'compiler' => 'true',
            'default'  => '',
        ),
        array(
            'id'       => 'opt_parent_menu_03',
            'type'     => 'text',
            'url'      => true,
            'title'    => __('Parent Menu 03'),
            'compiler' => 'true',
            'default'  => '',
        ),
    )
...
Redux::setSection($opt_name, array(
    ...
    'fields'           => array(
        array(
            ...
            'type'     => 'text',
            'url'      => true,
            'title'    => __('Profession Journal Page'),
            'compiler' => 'true',
            'default'  => '',
        ),
		array(
        ...
        array(
            ...
            'type'     => 'text',
            'url'      => true,
            'title'    => __('Website RS05'),
            'compiler' => 'true',
            'default'  => '',
        ),
        array(
            'id'       => 'website_companies_online_training',
            'type'     => 'text',
            'url'      => true,
            'title'    => __('Website Corporate companies Accounting department Online training'),
            'compiler' => 'true',
            'default'  => '',
        ),
        array(
...
Redux::setSection($opt_name, array(
    'title'            => __('Account Home Page'),
    'id'               => 'account_home_page',
    'subsection'       => true,
    'customizer_width' => '450px',
    'fields'           => array(
        array(
            'id'       => 'slug_account_home_page',
            'type'     => 'text',
            'url'      => true,
            'title'    => __('Slug'),
            'compiler' => 'true',
